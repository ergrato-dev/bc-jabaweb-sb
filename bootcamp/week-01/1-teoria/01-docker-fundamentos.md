...
![Docker: Contenedores Aislados](../0-assets/01-docker-containers.svg)
...
![Capas de una Imagen Docker](../0-assets/02-docker-image-layers.svg)
...
![Contenedor = Imagen + Capa de Escritura](../0-assets/03-docker-container-layers.svg)
...
![Volúmenes: Persistencia y Sincronización](../0-assets/04-docker-volumes.svg)
...
> 💡 Los contenedores en la misma red pueden comunicarse por nombre (DNS interno de Docker).
> Por ejemplo, desde el contenedor `app` puedes conectar a `db:5432`.
