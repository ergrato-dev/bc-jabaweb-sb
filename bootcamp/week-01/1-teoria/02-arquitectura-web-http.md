...
![Arquitectura Cliente-Servidor](../0-assets/05-client-server-architecture.svg)
...
| **Mobile App** | iOS App, Android App, Flutter |
| **Desktop App** | Electron, Java, Python |
| **CLI** | curl, HTTPie, Postman |
...
![Métodos HTTP y CRUD](../0-assets/07-http-methods-crud.svg)
...
![Estructura HTTP Request y Response](../0-assets/06-http-request-response.svg)

### 4.1 Request (Petición)

Componentes del request:
- **Request Line**: Método + Ruta + Versión HTTP
...
- **Status Line**: Versión HTTP + Código + Mensaje
- **Headers**: Metadatos de la respuesta
- **Body**: Datos devueltos

---

## 5. Códigos de Estado HTTP

![Códigos de Estado HTTP](../0-assets/08-http-status-codes.svg)
